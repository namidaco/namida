              ...
              builder: (double height, double p) {
                ...
                return Column(
                  children: [
                    ...
                    // ---- thats why [isInYTCommentsSubpage] is here.
                    if (NamidaNavigator.inst.isInYTCommentsSubpage ? true : percentage > 0)
                      Expanded(
                        child: Stack(
                                              ...
                                              slivers: [
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: Wrap(
                                                        ...
                                                        children: [
                                                          ...
                                                          SmallYTActionButton(
                                                            title:
                                                                (videoDislikeCount ?? 0) < 1 ? lang.DISLIKE : videoDislikeCount?.formatDecimalShort(isTitleExpanded.value) ?? '?',
                                                            icon: Broken.dislike,
                                                            onPressed: () {},
                                                          ),
                                                          const SizedBox(width: 4.0),
                                                ...
                                                Obx(
                                                  () {
                                                    ...
                                                    final highlightedComment = comments.firstOrNull;
