                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Flexible(
                                                                        ...
                                                                        child: Obx(
                                                                          (context) {
                                                                            final audioProgress =
                                                                                YoutubeController.inst.downloadsAudioProgressMap[currentIdTask]?.values.firstOrNull;
                                                                            final audioPercText = audioProgress?.percentageText(prefix: lang.AUDIO);
                                                                            final videoProgress =
                                                                                YoutubeController.inst.downloadsVideoProgressMap[currentIdTask]?.values.firstOrNull;
