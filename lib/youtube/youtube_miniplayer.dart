                          ...
                          builder: (context, currentRelatedVideos) => ObxO(
                            ...
                            builder: (context, page) {
                              ...
                              final miniplayerBody = Obx(
                                (context) {
                                  final showLyrics =
                                      settings.enableLyrics.valueR && (Lyrics.inst.currentLyricsLRC.valueR != null || Lyrics.inst.currentLyricsText.valueR.isNotEmpty);
                                  return Stack(
                                                                ...
                                                                child: IgnorePointer(
                                                                  ...
                                                                  child: VideoTilePropertiesProvider(
                                                                    ...
                                                                    builder: (properties) => LazyLoadListView(
                                                                      ...
                                                                      onReachingEnd:
                                                                          ytTopComments ? () => false : () => YoutubeInfoController.current.updateCurrentComments(currentId),
                                                                      extend: 400,
                                                                                ...
                                                                                child: ShimmerWrapper(
                                                                                  ...
                                                                                  child: ExpansionTile(
                                                                                    ...
                                                                                    textColor: Color.alphaBlend(
                                                                                        CurrentColor.inst.miniplayerColor.withAlpha(40), mainTheme.colorScheme.onSurface),
                                                                                              ...
                                                                                              child: Text(
                                                                                                [
                                                                                                  if (videoViewCount != null)
                                                                                                    isTitleExpanded
                                                                                                        ? videoViewCount.displayViewsKeyword
                                                                                                        : videoViewCount.displayViewsKeywordShort,
                                                                                    ...
                                                                                    child: Row(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Flexible(
                                                                                          ...
                                                                                          child: ObxO(
                                                                                            ...
                                                                                            builder: (context, currentLikeStatus) {
                                                                                              ...
                                                                                              final videoLikeCount =
                                                                                                  (isUserLiked ? 1 : 0) + (videoInfo?.engagement?.likesCount ?? 0);
                                                                                              return ObxO(
                                                                                                rx: _isTitleExpanded,
                                                                                        ...
                                                                                        Flexible(
                                                                                          ...
                                                                                          child: Obx(
                                                                                            (context) {
                                                                                              final audioProgress = YoutubeController
                                                                                                  .inst.downloadsAudioProgressMap[currentIdTask]?.values.firstOrNull;
                                                                                              final audioPercText = audioProgress?.percentageText(prefix: lang.AUDIO);
                                                                                              final videoProgress = YoutubeController
                                                                                                  .inst.downloadsVideoProgressMap[currentIdTask]?.values.firstOrNull;
                                                                                              final videoPercText = videoProgress?.percentageText(prefix: lang.VIDEO);

                                                                                              final isDownloading = YoutubeController.inst.isDownloading[currentIdTask]?.values
                                                                                                      .any((element) => element) ==
                                                                                                  true;
                                                                                              ...
                                                                                              return SmallYTActionButton(
                                                                                                titleWidget: videoPercText == null && audioPercText == null && isDownloading
                                                                                ...
                                                                                child: ShimmerWrapper(
                                                                                  ...
                                                                                  child: Material(
                                                                                    ...
                                                                                    child: InkWell(
                                                                                      onTap: () async {
                                                                                        final channelInfo =
                                                                                            channel ?? YoutubeInfoController.current.currentVideoPage.value?.channelInfo;
                                                                                        String? chid =
                                                                                            channel?.id ?? YoutubeInfoController.current.currentVideoPage.value?.channelInfo?.id;
                                                                                          ...
                                                                                          return Row(
                                                                                            children: [
                                                                                              ...
                                                                                              NamidaDummyContainer(
                                                                                                ...
                                                                                                borderRadius: 100.0,
                                                                                                shimmerEnabled:
                                                                                                    channelThumbnail == null && (channelID == null || channelID.isEmpty),
                                                                                      ...
                                                                                      builder: (context, comments) => ShimmerWrapper(
                                                                                        ...
                                                                                        child: NamidaInkWell(
                                                                                          ...
                                                                                          bgColor: Color.alphaBlend(
                                                                                              mainTheme.scaffoldBackgroundColor.withValues(alpha: 0.4), mainTheme.cardColor),
                                                                                            ...
                                                                                            children: [
                                                                                                ...
                                                                                                children: [
                                                                                                  ...
                                                                                                  Expanded(
                                                                                                    child: Text(
                                                                                                      [
                                                                                                        lang.COMMENTS,
                                                                                                        if (comments?.commentsCount != null)
                                                                                                          comments!.commentsCount!.formatDecimalShort(),
                                                                                                      ].join(' • '),
                                                                                              ...
                                                                                              ObxO(
                                                                                                ...
                                                                                                builder: (context, loading) => ShimmerWrapper(
                                                                                                  ...
                                                                                                  child:
                                                                                                      YTCommentCardCompact(comment: loading ? null : comments?.items.firstOrNull),
                                                                                                ),
                                                                                              )
                                                                                            ],
                                                                                          ),
                                                                                            ...
                                                                                            return SliverVariedExtentList.builder(
                                                                                              ...
                                                                                              itemExtentBuilder: (index, dimensions) {
                                                                                                if (isShortsVisible) {
                                                                                                  ...
                                                                                                  } else if (currentRelatedVideos.shortsSection.shortsIndicesLookup[index] ==
                                                                                                      true) {
                                                                                                    return 0;
                                                                                                  }
                                                                                                }
