...
final String kLatestQueueFilePath = '${kQueuesFolderPath}latestqueue.json';
final String kHistoryPlaylistFilePath = '${kPlaylistsFolderPath}sussybaka.json';
final String kHistoryPlaylistBackupFilePath = '${kPlaylistsFolderPath}sussybakabk.json';
final String kFavouritesPlaylistFilePath = '${kPlaylistsFolderPath}favs.json';

final String kPlaylistsFolderPath = '$kAppDirectoryPath/Playlists/';
final String kQueuesFolderPath = '$kAppDirectoryPath/Queues/';
...
const kPlaylistFavourites = '_FAVOURITES_';
const kPlaylistHistory = '_HISTORY_';
const kPlaylistMostPlayed = '_MOST_PLAYED_';
const kPlaylistAutoGenerated = '_AUTO_GENERATED_';
