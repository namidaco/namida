...
class Language extends LanguageKeys {
  ...
  Future<bool> update({required NamidaLanguage lang, Map<String, dynamic>? trMap}) async {
    ...
    NamidaLanguage language = lang;
    try {
      late Map<String, dynamic> map;
      try {
        map = await jsonDecode(await rootBundle.loadString(path)) as Map<String, dynamic>;
      } catch (e) {
        language = kDefaultLang;
        map = trMap ?? _defaultMap;
      }
      String getKey(String key) => map[key] ?? '';

      // -- Keys Start ---------------------------------------------------------
      ABOUT = getKey("ABOUT");
      ACTIVE = getKey("ACTIVE");
      ADD_FOLDER = getKey("ADD_FOLDER");
      ADD_LANGUAGE = getKey("ADD_LANGUAGE");
      ADD_LANGUAGE_SUBTITLE = getKey("ADD_LANGUAGE_SUBTITLE");
      ...
      DISMISSIBLE_MINIPLAYER = getKey("DISMISSIBLE_MINIPLAYER");
      ...
      DISPLAY_ARTIST_BEFORE_TITLE = getKey("DISPLAY_ARTIST_BEFORE_TITLE");
      ...
      DONE = getKey("DONE");
      DONT_ASK_AGAIN = getKey("DONT_ASK_AGAIN");
      ...
      ENABLE_M3U_SYNC = getKey("ENABLE_M3U_SYNC");
      ENABLE_M3U_SYNC_NOTE_1 = getKey("ENABLE_M3U_SYNC_NOTE_1");
      ENABLE_M3U_SYNC_NOTE_2 = getKey("ENABLE_M3U_SYNC_NOTE_2");
      ENABLE_M3U_SYNC_SUBTITLE = getKey("ENABLE_M3U_SYNC_SUBTITLE");
      ...
      EXIT = getKey("EXIT");
      EXPORT_AS_M3U = getKey("EXPORT_AS_M3U");
      ...
      FORCE_MINIPLAYER_FOLLOW_TRACK_COLORS = getKey("FORCE_MINIPLAYER_FOLLOW_TRACK_COLORS");
      ...
      GRANT_STORAGE_PERMISSION = getKey("GRANT_STORAGE_PERMISSION");
      ...
      IMMERSIVE_MODE = getKey("IMMERSIVE_MODE");
      IMMERSIVE_MODE_SUBTITLE = getKey("IMMERSIVE_MODE_SUBTITLE");
      ...
      ITEM = getKey("ITEM");
      I_READ_AND_AGREE = getKey("I_READ_AND_AGREE");
      ...
      M3U_PLAYLIST = getKey("M3U_PLAYLIST");
      ...
      RESET_BRIGHTNESS = getKey("RESET_BRIGHTNESS");
      ...
      SETUP_FIRST_STARTUP = getKey("SETUP_FIRST_STARTUP");
      ...
      settings.save(selectedLanguage: language);
      language.refreshConverterMaps();
