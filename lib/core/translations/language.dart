  ...
  Future<bool> update({required NamidaLanguage lang, Map<String, dynamic>? trMap}) async {
    ...
    try {
      ...
      // -- Keys Start ---------------------------------------------------------
			...
			AT_LEAST_ONE_FILTER_SUBTITLE = getKey("AT_LEAST_ONE_FILTER_SUBTITLE");
			AT_LEAST_ONE_FILTER = getKey("AT_LEAST_ONE_FILTER");
			AT_LEAST_THREE_TABS_SUBTITLE = getKey("AT_LEAST_THREE_TABS_SUBTITLE");
			AT_LEAST_THREE_TABS = getKey("AT_LEAST_THREE_TABS");
			AUDIO = getKey("AUDIO");
			...
			CLEAR_WAVEFORM_DATA_WARNING = getKey("CLEAR_WAVEFORM_DATA_WARNING");
			CLEAR_WAVEFORM_DATA = getKey("CLEAR_WAVEFORM_DATA");
			CLEAR = getKey("CLEAR");
			CLOCK = getKey("CLOCK");
			...
			FORCE_STOP_WAVEFORM_GENERATION = getKey("FORCE_STOP_WAVEFORM_GENERATION");
			FORMAT = getKey("FORMAT");
			FROM_NOW = getKey("FROM_NOW");
			GENERATE_ALL_WAVEFORM_DATA_SUBTITLE = getKey("GENERATE_ALL_WAVEFORM_DATA_SUBTITLE");
			GENERATE_ALL_WAVEFORM_DATA = getKey("GENERATE_ALL_WAVEFORM_DATA");
			...
			IMPORT_TIME_RANGE_PROMPT = getKey("IMPORT_TIME_RANGE_PROMPT");
			...
			MINIMUM_ONE_FIELD_SUBTITLE = getKey("MINIMUM_ONE_FIELD_SUBTITLE");
			MINIMUM_ONE_FIELD = getKey("MINIMUM_ONE_FIELD");
			MINIMUM_ONE_FOLDER_SUBTITLE = getKey("MINIMUM_ONE_FOLDER_SUBTITLE");
			MINIMUM_ONE_FOLDER = getKey("MINIMUM_ONE_FOLDER");
			MINIMUM_ONE_QUALITY_SUBTITLE = getKey("MINIMUM_ONE_QUALITY_SUBTITLE");
			MINIMUM_ONE_QUALITY = getKey("MINIMUM_ONE_QUALITY");
			...
			RESTART_TO_APPLY_CHANGES = getKey("RESTART_TO_APPLY_CHANGES");
			RESTART = getKey("RESTART");
			...
			WAVEFORM_DATA = getKey("WAVEFORM_DATA");
			WAVEFORMS_DATA = getKey("WAVEFORMS_DATA");
      ...
      SettingsController.inst.save(selectedLanguage: lang);
      return true;
    } catch (e) {
