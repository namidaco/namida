...
extension PLNAME on String {
  String get translatePlaylistName => replaceFirst(kPlaylistAutoGenerated, Language.inst.AUTO_GENERATED)
      .replaceFirst(kPlaylistFavourites, Language.inst.FAVOURITES)
      .replaceFirst(kPlaylistHistory, Language.inst.HISTORY)
      .replaceFirst(kPlaylistMostPlayed, Language.inst.MOST_PLAYED);
}
