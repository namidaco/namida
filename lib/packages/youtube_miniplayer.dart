                                            ...
                                            child: ListView(
                                              ...
                                              children: [
                                                ...
                                                ExpansionTile(
                                                  ...
                                                  textColor: Color.alphaBlend(CurrentColor.inst.color.value.withAlpha(40), Get.theme.colorScheme.onBackground),
                                                  collapsedTextColor: Get.theme.colorScheme.onBackground,
                                                  iconColor: Color.alphaBlend(CurrentColor.inst.color.value.withAlpha(40), Get.theme.colorScheme.onBackground),
                                                  collapsedIconColor: Get.theme.colorScheme.onBackground,
